...
<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
  <tr>
	...
	<!-- Item 1 Strat -->
      ...
      <!-- Item 2 Strat -->
      <dl class='bitem'>
        <dt onClick='showHide("items2_1")'><b>企业管理</b></dt>
        <dd style='display:block' class='sitem' id='items2_1'>
          <ul class='sitemu'>
            <li><a href='<?php echo site_url('admin_login/qy_manage/list_all_qy');?>' target='main'>企业列表</a></li>
            <li><a href='<?php echo site_url('admin_login/qy_manage/add_qiye');?>' target='main'>添加企业</a></li>
          </ul>
        </dd>
      </dl>
      <!-- Item 2 End -->
